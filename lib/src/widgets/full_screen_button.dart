...
class FullScreenButton extends StatefulWidget {
  ...
  final void Function(Function callback)? rotateScreenCallBack;
...
class _FullScreenButtonState extends State<FullScreenButton> {
  ...
  void didChangeDependencies() {
    ...
    if (widget.rotateScreenCallBack != null) {
      widget.rotateScreenCallBack!(_controller.toggleFullScreenMode);
    }
  }
